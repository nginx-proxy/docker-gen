...
![latest v0.4.2](https://img.shields.io/badge/latest-v0.4.2-green.svg?style=flat)
...
Linux/OSX binaries for release [0.4.2](https://github.com/jwilder/docker-gen/releases)

* [amd64](https://github.com/jwilder/docker-gen/releases/download/0.4.2/docker-gen-linux-amd64-0.4.2.tar.gz)
* [i386](https://github.com/jwilder/docker-gen/releases/download/0.4.2/docker-gen-linux-i386-0.4.2.tar.gz)

Download the version you need, untar, and install to your PATH.

```
$ wget https://github.com/jwilder/docker-gen/releases/download/0.4.2/docker-gen-linux-amd64-0.4.2.tar.gz
$ tar xvzf docker-gen-linux-amd64-0.4.2.tar.gz
$ ./docker-gen
```
