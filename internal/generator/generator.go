...
func (g *generator) getContainers(config config.Config) ([]*context.RuntimeContainer, error) {
	...
	for _, apiContainer := range apiContainers {
		...
		var netSettings docker.NetworkSettings
